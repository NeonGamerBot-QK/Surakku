export function createMenuIcon(img: string, name: string, cb: () => void | Promise<void>) {
  ...
  button.className = "c-button-unstyled p-tab_rail__button c-tabs__tab js-tab c-tabs__tab--full_width";
  button.id = name;
  ...
  activityDiv.className = "p-activity_toast_ia2022__link__icon p-activity_toast_ia2022__link__activity";
  ...
  try {
    document
      ...
      ?.children[1].children[1].children[0].children[0].appendChild(
        div,
      );
  } catch (e) {
    console.error(e);
