export function createMenuIcon(img:string, name: string) {
     ...
     */
    try {
        document.querySelector('.p-tab_rail')?.children[1].children[1].children[0].children[0].children[0].appendChild(imgElement);
    } catch (e) {
        console.error(e);
    }
    finally {
